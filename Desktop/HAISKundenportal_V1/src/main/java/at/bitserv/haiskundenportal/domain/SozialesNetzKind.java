 ...
 */
@Entity
@Table(name = "SozialesNetzKind", catalog = "hais_lgs", schema = "hais")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "SozialesNetzKind.findAll", query = "SELECT s FROM SozialesNetzKind s")})
public class SozialesNetzKind implements Serializable {
    ...
    public Character getWichtigste() {
        return wichtigste;
    }

    public void setWichtigste(Character wichtigste) {
        this.wichtigste = wichtigste;
    }
